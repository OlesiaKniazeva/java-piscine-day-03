...
public class Downloader implements Runnable {
    ...
    public void run() {
        ...
        try {
            System.out.println("Thread-" + id + " start download file number " + index);
            ...
            fos.close();
            rbc.close();
            System.out.println("Thread-" + id + " finish download file number " + index);
        } catch (IOException e) {
            System.out.println("Couldn't download from URL: " + link);
        }
    }
}
